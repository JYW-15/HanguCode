...
print(time.taken11)
write.csv(df11_FullSeq_K2,file="../Generated Data/Fullseq2/Model2_55/Fullseq_8_8.csv",row.names = F)
}else{
df11_FullSeq_K2 = read.csv("../Generated Data/Fullseq2/Model2_55/Fullseq_8_8.csv",stringsAsFactors = F)
...
################################################
write.csv(df12_FullSeq_K2,file="../Generated Data/Fullseq2/Model2_55/Fullseq_9_7.csv",row.names = F)

}else{
df12_FullSeq_K2 = read.csv("../Generated Data/Fullseq2/Model2_55/Fullseq_9_7.csv",stringsAsFactors = F)
# working for loaded df_FullSeq file 
...
write.csv(df21_FullSeq,file="../Generated Data/Fullseq2/Fullseq_NewReturn_6_10.csv",row.names = F)
}else{
df21_FullSeq = read.csv("../Generated Data/Fullseq2/Fullseq_NewReturn_6_10.csv",stringsAsFactors = F)
# working for loaded df_FullSeq file 
...
write.csv(df22_FullSeq,file="../Generated Data/Fullseq2/Fullseq_NewReturn_7_9.csv",row.names = F)
}else{
df22_FullSeq = read.csv("../Generated Data/Fullseq2/Fullseq_NewReturn_7_9.csv",stringsAsFactors = F)
# working for loaded df_FullSeq file 
...
write.csv(df11_FullSeq,file="../Generated Data/Fullseq3/Model2_55/Fullseq_class_0_13_3.csv",row.names = F)

}else{
df11_FullSeq = read.csv("../Generated Data/Fullseq3/Model2_55/Fullseq_class_0_13_3.csv",stringsAsFactors = F)
...
write.csv(df12_FullSeq,file="../Generated Data/Fullseq3/Model2_55/Fullseq_class_0_14_2.csv",row.names = F)
}else{
df12_FullSeq = read.csv("../Generated Data/Fullseq3/Model2_55/Fullseq_class_0_14_2.csv",stringsAsFactors = F)
# working for loaded df file 
...
write.csv(df13_FullSeq,file="../Generated Data/Fullseq3/Model2_55/Fullseq_class_1_13_2.csv",row.names = F)
}else{
df13_FullSeq = read.csv("../Generated Data/Fullseq3/Model2_55/Fullseq_class_1_13_2.csv",stringsAsFactors = F)
# working for loaded df file 
